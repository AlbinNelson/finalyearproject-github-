...
const PipelineTicket = ({allTickets,setAllTickets,ticket,subaccountId,index}:Props) => {
            ...
            {(provided,snapshot)=>{
                ...
                return(
                    ...
                    >
                        <AlertDialog>
                            <DropdownMenu>
                                <Card className="my-4 dark:bg-slate-900 gb-white shadow-none transition-all">
